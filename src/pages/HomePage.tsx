        ...
        <StringKeyTable
            ...
            rows={
                [
                    ...
                    {id: "d", firstColumn: "testd", secondColumn: "test4", thirdColumn: "test34", extra: "lol"},
                    {id: "e", firstColumn: "teste", secondColumn: "test5", thirdColumn: "test35", extra: "lol"},
                    {id: "f", firstColumn: "testf", secondColumn: "test6", thirdColumn: "test36", extra: "lol"},
                    {id: "g", firstColumn: "testg", secondColumn: "test7", thirdColumn: "test37", extra: "lol"},
                    {id: "h", firstColumn: "testh", secondColumn: "test8", thirdColumn: "test38", extra: "lol"},
                    {id: "i", firstColumn: "testi", secondColumn: "test9", thirdColumn: "test39", extra: "lol"},
